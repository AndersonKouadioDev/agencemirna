...
/**
 * Section "Actualités & Conseils" — 3 articles éditoriaux statiques
 * pour positionner Mirna comme un acteur de référence du marché
 * immobilier abidjanais.
 *
 * Évolution future : remplaçable par un fetch d'une table `articles`
 * Supabase (avec MDX, tags, auteur, etc.).
 */
  ...
  return (
    <MotionSection className="bg-[#FAF5EE] py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        {/* Header avec CTA "Tous les articles" */}
        ...
        <MotionStagger className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {ARTICLES.map((article) => (
            <MotionStaggerChild key={article.title}>
              <Link
                href={article.href}
